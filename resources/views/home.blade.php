                ...
                <table class="table">
                    ...
                    @foreach($personas as $persona)
                        <tr>
                            ...
                            <td>
                            <a title="Registrar ingreso" href="{{route('ingreso.create',$persona->id)}}">
                            ...
                            <a title="Historial" href="{{route('ingreso.historial',$persona->id)}}">
                            ...
                            <a title="Imprimir Acta" href="{{route('persona.imprimiracta',$persona->id)}}">
                            ...
                            <a title="Editar" href="{{route('persona.editar',$persona->id)}}">
